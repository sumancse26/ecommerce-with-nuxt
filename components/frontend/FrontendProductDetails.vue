...
<template>
    <FrontendBreadcum title="Product Details" />
                ...
                <div class="pr_detail">
                    ...
                    <div class="cart_extra">
                        <div class="cart-product-quantity">
                            <div class="quantity">
                                <input @click="qty > 1 ? qty-- : (qty = 1)" type="button" value="-" class="minus" />
                                <input v-model="qty" type="number" name="quantity" title="Qty" class="qty" size="4" />
